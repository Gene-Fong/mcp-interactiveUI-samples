<#
.SYNOPSIS
    ServerDeploy -- build the SN MCP server image, deploy it to the Azure
...
Assert-Tool -Name "az" `
    -Why "Needed for the image build and container update (acr build, containerapp update, containerapp show)." `
