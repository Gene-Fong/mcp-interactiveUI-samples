// Ask - HubSpot — Azure Container Apps deployment.
//
// Deploys: ACR, Log Analytics workspace, Container Apps environment,
//          managed identity (AcrPull), and the lob-mcp-apps-hs Container App.
...
param appInsightsRoleName string = 'lob-mcp-hs'
...
resource caHs 'Microsoft.App/containerApps@2024-03-01' = {
  name: 'lob-mcp-apps-hs'
  location: location
  identity: {
    type: 'UserAssigned'
...
@description('Public HTTPS URL of the HS Copilot container app')
output hsUrl string = 'https://${caHs.properties.configuration.ingress.fqdn}'
