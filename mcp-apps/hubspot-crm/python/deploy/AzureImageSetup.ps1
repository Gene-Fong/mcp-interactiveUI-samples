...
.SYNOPSIS
    ...
    hosts the HS MCP server. Idempotent: safe to run any number of times.
...
.NOTES
    ...
    Contributor rights. Run from hubspot-crm/python/.
#>
...
$deploymentName   = 'lob-mcp-apps-hs-setup'

Write-Host ""
Write-Host "  =====================================" -ForegroundColor DarkCyan
Write-Host "   SERVER SETUP -- Azure infra for HS" -ForegroundColor Cyan
Write-Host "  =====================================" -ForegroundColor DarkCyan
Write-Host ""
